<template>
    <nav class="fixed inset-x-0 top-3 sm:top-4 md:top-12 flex justify-center z-50 pointer-events-auto">
        ...
        <transition name="fade">
            <div v-if="mobileOpen"
                class="absolute left-1/2 transform -translate-x-1/2 mt-[60px] sm:mt-[68px] md:mt-[70px] w-full max-w-[1150px] mx-2 sm:mx-3 md:mx-5 bg-black/90 backdrop-blur-md rounded-lg p-3 sm:p-4 md:hidden"
