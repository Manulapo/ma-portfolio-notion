<template>
    <div class="flex flex-col items-center" ref="root">
        <div
            class="bg-black text-white rounded-lg h-20 w-20 sm:h-24 md:w-36 md:h-36 flex items-center justify-center text-4xl sm:text-4xl md:text-7xl font-extrabold">
            {{ displayValue }}
        </div>
